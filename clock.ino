...
CRGB clockColors[][4] = {
  ...
  {CRGB::MediumBlue,CRGB::MediumBlue,CRGB::MediumBlue,CRGB::MediumBlue},//night mode
};
...
uint8_t showHue = 0; //rotatin    g "base color" used by light show patterns
...
void loop(){
  ...
  EVERY_N_MILLISECONDS(20){showHue++;}//slowly cycle the "base color" through the rainbow for light show effects
